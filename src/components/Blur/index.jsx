import { HomeLeft, HomeRight, SkillsLeft, ProjectsRight, ProjectsLeft, ContactRight, ContactLeft, FinalLeft, ContactRightExtra, ContactLeftExtra } from './styles';
...
export function Blur() {
    ...
    return (
     ...
     <ContactRightExtra  $background={TITLE === "dark" ? "#1d2333" : "rgb(230, 220, 255)"}/>
     <ContactLeftExtra  $background={TITLE === "dark" ? "#1c2642" : "rgb(221, 208, 255)"}/>
